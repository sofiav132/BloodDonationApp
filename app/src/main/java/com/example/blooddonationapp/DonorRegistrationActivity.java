...
public class DonorRegistrationActivity extends AppCompatActivity {
    ...
    private TextInputEditText registerFullName, registerNIK, registerPhoneNumber, registerEmail, registerPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerNIK = findViewById(R.id.registerNIK);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String NIK = registerNIK.getText().toString().trim();
                ...
                if (TextUtils.isEmpty(NIK)){
                    registerNIK.setError("NIK is required");
                    return;
                }
